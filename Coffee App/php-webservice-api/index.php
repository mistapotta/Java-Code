...
define('API_KEY', 'vfWHncuKQmFY4ezEmVUTSSsAaGeufzJgTb2n4Zb8Vk8HfzPSuZy9KXRSD6DguxDG');
...
$app->configureMode('production', function () use ($app) {
    ...
    $options = array(
        'driver' => 'mysqli',
        'host' => 'mysql51-118.wc1.dfw1.stabletransit.com',
        'user' => '382544_coffeecar',
        'password' => 'GATech2014',
        'database' => '382544_coffeecart',
        'prefix' => '',
        'port' => 3306
    );

    $app->db = \Joomla\Database\DatabaseDriver::getInstance($options);
});
...
$app->group('/api', function () use ($app) {
    ...
    include __DIR__ . '/code/app/customers.php';
    include __DIR__ . '/code/app/items.php';
    include __DIR__ . '/code/app/itemtypes.php';
    include __DIR__ . '/code/app/locations.php';
    include __DIR__ . '/code/app/preorders.php';
    include __DIR__ . '/code/app/purchases.php';
    include __DIR__ . '/code/app/reports.php';
...
$app->hook('slim.before', function () use ($app){
    ...
    if (isset($headers['Authorization']) && $headers['Authorization'] !== API_KEY)
    {
        ...
        $app->halt(403, json_encode(array('message' => 'Provided API Key was incorrect')));
    }
});
